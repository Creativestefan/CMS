import svgPaths from "./svg-evyz8386m8";
...
function Button() {
  return (
    <div className="bg-[rgba(39,39,42,0.06)] content-stretch flex items-center justify-center min-h-[28px] min-w-[28px] overflow-clip relative rounded-[9999px] shrink-0" data-name="Button">
      <LeadIcon />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[16px] top-[24px] w-[370px]">
      <div className="flex flex-col font-['Season_Mix-TRIAL:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#111115] text-[16px] text-nowrap tracking-[-0.16px]">
...
function Frame19() {
  return (
    <div className="basis-0 content-stretch flex gap-[6px] grow items-center min-h-px min-w-px relative shrink-0">
      ...
      <Frame18 />
      <div className="basis-0 flex flex-col font-['Season_Mix-TRIAL:Medium',sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#111115] text-[14px] tracking-[-0.14px]">
        <p className="leading-[1.2]">Genius on Demand</p>
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-[16px] max-w-[436px] top-[82px] w-[370px]">
      <Frame10 />
      <Frame8 />
    </div>
  );
