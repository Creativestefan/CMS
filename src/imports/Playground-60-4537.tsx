import svgPaths from "./svg-k3t70qfdph";
...
function Button() {
  return (
    <div className="absolute bg-[rgba(39,39,42,0.06)] content-stretch flex items-center justify-center min-h-[28px] min-w-[28px] overflow-clip right-0 rounded-[9999px] top-0" data-name="Button">
      <LeadIcon />
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="gap-[24px] grid grid-cols-[repeat(6,_minmax(0px,_1fr))] grid-rows-[fit-content(100%)_fit-content(100%)_minmax(0px,_1fr)] h-[595.5px] relative shrink-0 w-[1360px]">
      <Frame2 />
      <Frame3 />
      <Frame4 />
      <Frame5 />
